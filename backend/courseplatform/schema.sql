...
create index if not exists idx_password_resets_student_active on courseplatform.student_password_resets(student_id, created_at desc)
  where consumed_at is null and invalidated_at is null;
create index if not exists idx_password_reset_attempts_source_created on courseplatform.student_password_reset_attempts(source_hash, created_at desc);
