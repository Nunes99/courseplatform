-- Etapa 4: materializa o contrato Realtime anteriormente verificado no pedido.
-- Repetível: funções e trigger são substituídos; a policy é recriada.
-- Requer o esquema Realtime gerido pelo Supabase.
